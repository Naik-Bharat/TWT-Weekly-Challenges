...
def print_extra_stats(
    ...
    print(
        f" - Number of X wins: {yellow}"
        f"{test_out.count('X'):_}{reset}"
    )
    print(
        f" - Number of O wins: {yellow}"
        f"{test_out.count('O'):_}{reset}"
    )
    print(
        f" - Number of Ties: {yellow}"
        f"{test_out.count('Tie'):_}{reset}"
    )
