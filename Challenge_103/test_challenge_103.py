...
class Config:
    ...
    TEST_CASE_FILE = "test_cases.json.gz"  #  1k test cases max A length 10_000
    # TEST_CASE_FILE = "test_cases_b.json.gz"    # 1k test cases max A length 100_000
...
def print_extra_stats(
    ...
    print(f" - max A length: {yellow}" f"{max(len(x[0]) for x in test_inp):_}{reset}")
    print(
        f" - Average A length: {yellow}"
