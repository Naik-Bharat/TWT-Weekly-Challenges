...
class Config:
    ...
    # TEST_CASE_FILE = "test_cases_b.json.gz"  # 500 test cases max n 100_000
...
def print_extra_stats(test_inp: TestInp, test_out: TestOut, num_cases: int) -> None:
    print(f" - Max number of Diamonds: {yellow}" f"{max(int(x[0]) for x in test_inp):_}{reset}")
    print(
        f" - Average number of Diamonds: {yellow}"
